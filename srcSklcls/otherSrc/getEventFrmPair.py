...
def geteFrmPairSim(dataFilePath, M, toolDirPath):
    ...
    for item in sorted(fileList):
        ...
        '''
        # V1 sim(frm1, frm2) = sum(sim(skl1i, skl2i))
        ...
        #print segPairs
        '''
        # V2 sim(frm1, frm2) dependent of skls
        [unitHash, unitDFHash, unitInvolvedHash] = loadEvtseg(btyFrmName)
        ...
        while 1:
            ...
            if hour >= (m+m_step):
                ...
                #[GUA] segmentDFHash mapping: segID -> f_st
                #[GUA] segmentDFHash mapping: twitterNum
                #m_segPairHash = calSegPairSim(m_eSegAppHash, m_eSegTextHash, unitDFHash, m_docNum, segPairs) # frm through skls
